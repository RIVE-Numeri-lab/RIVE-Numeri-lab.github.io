...
d'applications Shiny sur le site officiel : https://shiny.rstudio.com/gallery/
...
runApp(appli)
```
![](screenshots/Screen Shot 2020-12-23 at 09.33.01.png)
...
runApp(appli2)
```
![](screenshots/Screen Shot 2020-12-23 at 09.33.40.png)
...
![](screenshots/Screen Shot 2021-04-09 at 13.36.38.png)
...
runApp(appli_quiz)
```
![](screenshots/Screen Shot 2021-04-09 at 14.15.55.png)
...
![](screenshots/Screen Shot 2020-12-23 at 09.52.19.png)
...
dans votre navigateur web. Mon application de quiz par exemple se trouve à l'adresse : https://charlesmartin.shinyapps.io/QuizCorrelation/. Si jamais vous perdez l'adresse de votre application, vous avez accès à la liste de toutes vos applications dans votre compte sur shinyapps.io
...
runApp(appli)
```
![](screenshots/Screen Shot 2020-12-23 at 09.39.41.png)
...
runApp(appli)
```
![](screenshots/Screen Shot 2020-12-23 at 09.40.22.png)
...
runApp(appli)
```
![](screenshots/Screen Shot 2020-12-23 at 09.40.49.png)
...
runApp(appli)
```
![](screenshots/Screen Shot 2020-12-23 at 09.41.16.png)
...
* L'aide mémoire de RStudio, contenant sur deux pages la liste de tous les contrôles et output disponibles : https://shiny.rstudio.com/images/shiny-cheatsheet.pdf
* Les tutoriels écrits par l'équipe de Shiny : https://shiny.rstudio.com/tutorial/#written-tutorials
* Des tutoriels en vidéo, aussi préparés par l'équipe de Shiny : https://shiny.rstudio.com/tutorial/#video-tutorials
* Des articles plus poussés sur des points très spécifiques comme l'amélioration de 
la performance, la personnalisation de l'interface etc. https://shiny.rstudio.com/articles/
