...
![](DADA2_files/figure-html/unnamed-chunk-13-1.png)<!-- -->

```r
p2
```

![](DADA2_files/figure-html/unnamed-chunk-13-2.png)<!-- -->
...
![](DADA2_files/figure-html/unnamed-chunk-19-1.png)<!-- -->

```r
pR + ggplot2::labs(title = "Error Reverse")
```

![](DADA2_files/figure-html/unnamed-chunk-19-2.png)<!-- -->
