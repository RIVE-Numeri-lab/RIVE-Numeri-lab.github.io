...
-   [Did my MCMC work well?](#did-my-mcmc-work-well)
    ...
    -   [Solution to problems with the MCMC process](#solution-to-problems-with-the-mcmc-process)
-   [Is my model good?](#is-my-model-good)
-   [Is this model better than another?](#is-this-model-better-than-another)
    -   [WAIC](#waic)
